    ...
    public partial class Department : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersRegistrations", x => x.UsersRegistrationId);
                    table.ForeignKey(
                        name: "FK_UsersRegistrations_Departments_DepartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersRegistrations_DepartmentId",
